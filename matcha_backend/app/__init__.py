...
def create_app():
    ...
    app.config["MONGO_URI"] = (
        f"mongodb+srv://{os.getenv('MONGO_ROOT_USERNAME')}:"
        f"{os.getenv('MONGO_ROOT_PASSWORD')}@woprcluster.s4jjn.mongodb.net/"
        f"{os.getenv('MONGO_DATABASE')}?retryWrites=true&w=majority&appName=woprcluster"
    )
